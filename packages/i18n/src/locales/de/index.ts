...
export const de = {
    ...
    "pluginDesktopConsent": {
        ...
        "detail": "Dies ist ein gefährlicher Desktop-Vorgang. Das Plugin hat das Risiko bestätigt; ob er ausgeführt wird, entscheiden Sie. Lehnen Sie ab, wenn Sie ihn nicht erwartet haben.",
    ...
    "chat": {
        ...
        "enhancementTimeout": "Die Umschreibung hat zu lange gedauert. Erneut versuchen oder in den Einstellungen ein schnelleres Modell wählen.",
    ...
    "settings": {
        ...
        sklm: {
            ...
            back: "Meine Skills",
            title: "Skill-Markt",
            subtitle: "Vorschau des vollständigen Dokuments vor dem Speichern.",
            ...
            remoteErrorUnresolved: "Der lokale Resolver konnte die Katalogquellen nicht auflösen – integrierte Auswahl wird angezeigt",
            previewResolveError: "Die Adressprüfung der App konnte diesen Host nicht auflösen – es wurde nichts installiert.",
            dnsHint: "Diese Prüfung löst den Host lokal auf, der Download selbst würde jedoch über deinen Proxy laufen. Wenn du einen Proxy, ein VPN oder ein eigenes DNS-Setup verwendest, prüfe Einstellungen → Allgemein → Netzwerk.",
            failureSourceHost: "{{name}} ({{host}})",
            remoteErrorFakeIp: "Dein Proxy hat die Katalogquellen mit fake-IP-Adressen beantwortet – integrierte Auswahl wird angezeigt",
            previewFakeIpError: "Dein Proxy hat diesen Host auf eine fake-IP-Adresse aufgelöst, daher hat die Adressprüfung der App abgelehnt – es wurde nichts installiert.",
            fakeIpHint: "Dein Proxy hat {{host}} mit {{address}} beantwortet – einem reservierten Benchmark-Bereich, den Proxys als fake-IP-Platzhalter verwenden, nicht der echten Adresse der Quelle. Stelle den Proxy auf Systemproxy-Modus um oder prüfe Einstellungen → Allgemein → Netzwerk.",
            fakeIpHintPlain: "Ein lokaler Proxy hat diesen Host auf einen fake-IP-Platzhalter in einem reservierten Bereich aufgelöst, nicht auf die echte Adresse der Quelle. Stelle den Proxy auf Systemproxy-Modus um oder prüfe Einstellungen → Allgemein → Netzwerk.",
        ...
        "pluginProviderManaged": "Dieser Anbieter stammt aus dem Plugin „{{plugin}}“, das Endpunkt und Modelle bereitstellt. Aktivieren oder deaktivieren Sie es auf der Seite „Erweiterungen“.",
        "pluginProviderKey": "API-Schlüssel",
        "pluginProviderKeyHint": "Wird in PI-Desktop gespeichert und von der Laufzeitumgebung verwendet. Das Plugin erhält ihn niemals.",
        ...
        "configSync": {
            ...
            allowInsecureHttpWarning: "HTTP verschlüsselt WebDAV-Anmeldedaten nicht. Nur für eine vertrauenswürdige LAN-Adresse aktivieren; öffentliche HTTP-Endpunkte werden abgelehnt.",
            remoteMode: "Server-Kompatibilität",
            remoteModeHint: "Der strikte Modus erfordert zuverlässige bedingte Schreibvorgänge. Verwende den Kompatibilitätsmodus nur für Server, die If-Match/If-None-Match ignorieren.",
            remoteModeStrict: "Striktes CAS (empfohlen)",
            remoteModeAppendOnly: "Kompatibilitätsmodus (nur anhängen)",
            appendOnlyWarning: "Dieser Modus ist für WebDAV-Server gedacht, die bedingte Schreibvorgänge ignorieren. Initialisiere den Tresor zuerst auf einem Gerät, bevor weitere Geräte beitreten. Er verwendet gerätespezifische Anhängeköpfe und behält den Remote-Verlauf; alle Geräte in diesem Tresor müssen den Kompatibilitätsmodus verwenden. Gleichzeitige Änderungen müssen möglicherweise geprüft werden.",
            appendOnlyConfirm: "Dieser Server kann bedingte Schreibvorgänge nicht erzwingen. Der Kompatibilitätsmodus behält den Verlauf, bietet aber kein atomares Compare-and-Swap. Fortfahren?",
            username: "Username",
        ...
        "mcpMarket": {
            ...
            back: "Meine Server",
            title: "MCP-Markt",
            subtitle: "Der genaue Befehl wird vor dem Speichern angezeigt.",
        ...
        "promptEnhancementDesc": "Gilt für die Aktion „Prompt verbessern“ im Composer. Der System-Prompt ist eingebaut; Nutzervorlage und Modell sind anpassbar.",
        "promptEnhancementCustomTemplate": "Eigene Vorlage verwenden",
        "promptEnhancementCustomTemplateDesc": "Ersetzt die eingebaute Nutzervorlage durch Ihre eigene. Der System-Prompt bleibt eingebaut.",
        "promptEnhancementCustomTemplateNeedsTemplate": "Speichern Sie zuerst eine eigene Vorlage; der Schalter wählt dann zwischen ihr und der eingebauten Vorlage.",
        ...
        "promptEnhancementThinkingDesc": "Denkaufwand für die Umschreibung. Standard ist Aus und am schnellsten.",
        "promptEnhancementThinkingOff": "Aus (kein Denken)",
        "promptEnhancementModelFollow": "Aktuellem Modell folgen",
        "promptEnhancementModelUnavailable": "Nicht verfügbar — die Verbesserung fällt auf das aktuelle Modell zurück",
        "promptEnhancementUserTemplate": "Benutzer-Vorlage",
        "promptEnhancementUserTemplateDesc": "Umschließt den Entwurf. Muss die Entwurfsvariable enthalten; fügen Sie sie über die Schaltfläche ein.",
        "promptEnhancementInsertDraft": "Entwurfsvariable einfügen",
        "promptEnhancementRestore": "Standard wiederherstellen",
        "promptEnhancementMissingDraftVariable": "Die Benutzer-Vorlage muss die Entwurfsvariable enthalten, sonst kann der Entwurf nicht gesendet werden.",
    ...
    "remote": {
        ...
        stepHint: {
            "method": "Wähle die Verbindungsart für diesen Arbeitsbereich und fülle die Konfiguration aus.",
            "config": "Trage die SSH-Daten ein; wir richten danach die Remote-Sitzung ein.",
            "connecting": "pi-host wird auf dem Remote-Rechner vorbereitet. Fenster offen lassen.",
            "folder": "Durchsuche die Verzeichnisse des Hosts und wähle den Projektordner.",
        },
        "methodTitle": "Verbindungsart wählen",
        "methodSsh": "SSH-Host",
        "methodSshDesc": "Remote-Host",
        "methodWslDesc": "Windows Linux-Subsystem",
        "methodDockerDesc": "Lokaler Container",
        "methodUnavailable": "Noch nicht verfügbar",
        "pairedHosts": "Gekoppelte Hosts",
        "configTitle": "Verbindung konfigurieren",
        "configNote": "Trage die SSH-Daten ein; wir richten danach die Remote-Sitzung ein.",
        "hostLabel": "Host",
        "hostPlaceholder": "Host-Adresse oder IP, z. B. 192.168.1.100",
        "portLabel": "Port",
        "userLabel": "Benutzername",
        "userPlaceholder": "Benutzernamen eingeben, z. B. root",
        "labelLabel": "SSH-Alias (optional)",
        "labelPlaceholder": "Kein Alias verwenden",
        "authLabel": "Authentifizierung",
        "authPassword": "Passwort",
        "authKey": "Privater Schlüssel",
        "passwordLabel": "Passwort",
        "passwordPlaceholder": "SSH-Passwort eingeben",
        "passwordHint": "Das Passwort liegt im System-Schlüsselbund, damit der Host nach einem Neustart erneut verbindet.",
        "identityLabel": "Pfad zum privaten Schlüssel",
        "identityPlaceholder": "Leer lassen für ~/.ssh/config und den Agenten",
        "identityHint": "Leer lassen — der ssh-Client wählt den Schlüssel.",
        "connectingTitle": "Verbindung wird hergestellt",
        "connecting": "Verbindung zum Remote-Host wird hergestellt…",
        "connectNote": "Bei der ersten Verbindung lädt und prüft der Remote-Rechner pi-host.",
        "connect": "Verbinden",
        "next": "Weiter",
        "back": "Zurück",
        stage: {
            "probe": "SSH-Verbindung prüfen",
            "resolve-release": "Release ermitteln",
            "download-checksum": "Prüfsumme laden",
            "install": "pi-host installieren",
            "forward": "Port-Forward aufbauen",
            "pair": "Koppeln und verbinden",
        },
        "wizardTitle": "Mit Remote-Host verbinden",
        "hostStep": "Remote-Host",
        "folderStep": "Ordner wählen",
        "nameStep": "Projektname",
        "submit": "Verbinden",
        "submitting": "Verbinde…",
        "loading": "Lädt…",
        "noFolders": "Keine Ordner hier",
        "browseRoot": "Home",
        "parent": "Ein Ordner höher",
        "online": "Online",
        "offline": "Offline",
        "browseFailed": "Dieser Ordner kann auf dem Host nicht gelesen werden.",
        "cancel": "Abbrechen",
        "noHosts": "Es ist noch kein Remote-Host gekoppelt. Füge ihn unter Einstellungen → Remote-Hosts hinzu und verbinde dich dann hier.",

    terminal: {
      "notRemoteTitle": "Terminal",
      "notRemoteBody": "Öffnen Sie eine Remote-Sitzung, um die Shell zu verwenden.",
      "opening": "Shell wird auf dem Remote-Host geöffnet…",
      "openFailed": "Auf diesem Host konnte keine Shell geöffnet werden.",
      "exited": "Die Shell wurde beendet.",
      "retry": "Wiederholen",
    },},
    "project": {
        "open": "Projekt öffnen",
        ...
        "openSourceMenu": "Projektquelle hinzufügen",
    ...
    "plugins": {
        ...
        "permissionHelp": {
            ...
            "usage.read": "Listet Nutzungsdaten abgeschlossener Runden auf (Token-Zähler pro Runde, seitenweise). Nachrichteninhalte sind nicht enthalten.",
        }
    },
    "extensions": {
        "scope": {
    ...
    "status": {
        ...
        "unsupportedGlibc": "Diese Linux-Version benötigt glibc 2.35 oder neuer (Ubuntu 22.04, Debian 12, Fedora 36+).",
        "dbSchemaTooNew": "Diese PI-Desktop-Version ist älter als Ihre lokalen Daten (Datenschema {{found}}, diese Version unterstützt {{supported}}). Installieren Sie die neuere PI-Desktop-Version, die diese Daten zuletzt geöffnet hat, oder eine spätere.",
        "archMismatch": "Dies ist die {{buildArch}}-Version auf einem {{machineArch}}-Rechner; sie läuft übersetzt und daher langsamer. Installieren Sie stattdessen die {{machineArch}}-Version.",
