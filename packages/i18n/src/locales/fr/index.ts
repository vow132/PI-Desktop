...
export const fr = {
    ...
    "pluginDesktopConsent": {
        ...
        "detail": "Il s'agit d'une opération de bureau dangereuse. Le plugin a reconnu le risque ; son exécution dépend de vous. Refusez si vous ne l'attendiez pas.",
    ...
    "chat": {
        ...
        "enhancementTimeout": "La réécriture a pris trop de temps. Réessayez, ou choisissez un modèle plus rapide dans les réglages.",
    ...
    "settings": {
        ...
        sklm: {
            ...
            subtitle: "Aperçu du document complet avant enregistrement.",
            ...
            remoteErrorUnresolved: "Le résolveur local n'a pas pu résoudre les sources du catalogue – sélection intégrée affichée",
            previewResolveError: "Le contrôle d'adresse de l'application n'a pas pu résoudre cet hôte – rien n'a été installé.",
            dnsHint: "Ce contrôle résout l'hôte localement, alors que le téléchargement passerait par votre proxy. Si vous utilisez un proxy, un VPN ou une configuration DNS personnalisée, vérifiez Paramètres → Général → Réseau.",
            failureSourceHost: "{{name}} ({{host}})",
            remoteErrorFakeIp: "Votre proxy a répondu avec des adresses fake-IP pour les sources du catalogue – sélection intégrée affichée",
            previewFakeIpError: "Votre proxy a résolu cet hôte en une adresse fake-IP ; le contrôle d'adresse de l'application l'a donc refusé – rien n'a été installé.",
            fakeIpHint: "Votre proxy a répondu {{host}} avec {{address}}, une plage de référence réservée que les proxys utilisent comme adresse factice, et non l'adresse réelle de la source. Passez le proxy en mode proxy système, ou vérifiez Paramètres → Général → Réseau.",
            fakeIpHintPlain: "Un proxy local a résolu cet hôte en une adresse factice d'une plage réservée, et non en l'adresse réelle de la source. Passez le proxy en mode proxy système, ou vérifiez Paramètres → Général → Réseau.",
        ...
        "pluginProviderManaged": "Ce fournisseur provient du plugin « {{plugin}} », qui fournit son point de terminaison et ses modèles. Activez-le ou désactivez-le dans la page « Extensions ».",
        "pluginProviderKey": "Clé API",
        "pluginProviderKeyHint": "Stockée dans PI-Desktop et utilisée par l'environnement d'exécution. Le plugin ne la reçoit jamais.",
        ...
        "configSync": {
            ...
            remoteModeHint: "Le mode strict exige des écritures conditionnelles fiables. Utilisez le mode de compatibilité uniquement avec un serveur qui ignore If-Match/If-None-Match.",
            remoteModeStrict: "CAS strict (recommandé)",
            remoteModeAppendOnly: "Mode de compatibilité (ajout uniquement)",
            appendOnlyWarning: "Ce mode est destiné aux serveurs WebDAV qui ignorent les écritures conditionnelles. Initialisez le coffre sur un appareil avant d’en joindre d’autres. Il utilise des têtes d’ajout par appareil et conserve l’historique distant ; tous les appareils de ce coffre doivent utiliser le mode de compatibilité. Les modifications simultanées peuvent nécessiter une vérification.",
            appendOnlyConfirm: "Ce serveur ne peut pas appliquer les écritures conditionnelles. Le mode de compatibilité conserve l’historique, mais ne fournit pas de compare-and-swap atomique. Continuer ?",
            username: "Username",
        ...
        "mcpMarket": {
            ...
            back: "Mes serveurs",
            title: "Marché MCP",
            subtitle: "La commande exacte est affichée avant tout enregistrement.",
        ...
        "promptEnhancementDesc": "S'applique à l'action « Améliorer le prompt » du compositeur. Le prompt système est intégré ; le modèle et le modèle de texte sont personnalisables.",
        "promptEnhancementCustomTemplate": "Utiliser un modèle personnalisé",
        "promptEnhancementCustomTemplateDesc": "Remplace le modèle utilisateur intégré par le vôtre. Le prompt système reste intégré.",
        "promptEnhancementCustomTemplateNeedsTemplate": "Enregistrez d'abord un modèle personnalisé ; l'interrupteur choisit ensuite entre celui-ci et le modèle intégré.",
        ...
        "promptEnhancementThinkingDesc": "Effort de raisonnement pour la réécriture. Désactivé est la valeur par défaut et la plus rapide.",
        "promptEnhancementThinkingOff": "Désactivé",
        "promptEnhancementModelFollow": "Suivre le modèle actuel",
        "promptEnhancementModelUnavailable": "Indisponible — l'amélioration utilisera le modèle actuel",
        "promptEnhancementUserTemplate": "Modèle utilisateur",
        "promptEnhancementUserTemplateDesc": "Encadre le brouillon. Doit contenir la variable de brouillon ; utilisez le bouton d'insertion.",
        "promptEnhancementInsertDraft": "Insérer la variable de brouillon",
        "promptEnhancementRestore": "Rétablir la valeur par défaut",
        "promptEnhancementMissingDraftVariable": "Le modèle utilisateur doit contenir la variable de brouillon, sinon le brouillon ne peut pas être envoyé.",
    ...
    "remote": {
        ...
        stepHint: {
            "method": "Choisissez comment entrer dans cet espace de travail, puis renseignez la configuration.",
            "config": "Renseignez les informations SSH ; nous préparerons la session distante.",
            "connecting": "Préparation de pi-host sur la machine distante. Gardez la fenêtre ouverte.",
            "folder": "Parcourez les répertoires de l'hôte et choisissez le dossier du projet.",
        },
        "methodTitle": "Choisir le type de connexion",
        "methodSsh": "Hôte SSH",
        "methodSshDesc": "Hôte distant",
        "methodWslDesc": "Sous-système Windows Linux",
        "methodDockerDesc": "Conteneur local",
        "methodUnavailable": "Pas encore disponible",
        "pairedHosts": "Hôtes associés",
        "configTitle": "Configurer la connexion",
        "configNote": "Renseignez les informations SSH ; nous préparerons la session distante.",
        "hostLabel": "Hôte",
        "hostPlaceholder": "Adresse ou IP, par exemple 192.168.1.100",
        "portLabel": "Port",
        "userLabel": "Utilisateur",
        "userPlaceholder": "Nom d'utilisateur, par exemple root",
        "labelLabel": "Alias SSH (facultatif)",
        "labelPlaceholder": "Ne pas utiliser d'alias",
        "authLabel": "Authentification",
        "authPassword": "Mot de passe",
        "authKey": "Clé privée",
        "passwordLabel": "Mot de passe",
        "passwordPlaceholder": "Mot de passe SSH",
        "passwordHint": "Le mot de passe est conservé dans le trousseau système pour la reconnexion.",
        "identityLabel": "Chemin de la clé privée",
        "identityPlaceholder": "Vide : ~/.ssh/config et l'agent",
        "identityHint": "Vide : le client ssh choisit la clé.",
        "connectingTitle": "Connexion en cours",
        "connecting": "Connexion à l'hôte distant…",
        "connectNote": "La première connexion télécharge et vérifie pi-host sur la machine distante.",
        "connect": "Se connecter",
        "next": "Suivant",
        "back": "Précédent",
        stage: {
            "probe": "Vérifier SSH",
            "resolve-release": "Résoudre la version",
            "download-checksum": "Télécharger la somme",
            "install": "Installer pi-host",
            "forward": "Ouvrir le tunnel",
            "pair": "Associer et connecter",
        },
        "wizardTitle": "Se connecter à un hôte distant",
        "hostStep": "Hôte distant",
        "folderStep": "Choisir un dossier",
        "nameStep": "Nom du projet",
        "submit": "Se connecter",
        ...
        "online": "En ligne",
        "offline": "Hors ligne",
        "browseFailed": "Ce dossier ne peut pas être listé sur l'hôte.",
        "cancel": "Annuler",
        "noHosts": "Aucun hôte distant n'est encore associé. Ajoutez-en un dans Paramètres → Hôtes distants, puis revenez ici.",

    terminal: {
      "notRemoteTitle": "Terminal",
      "notRemoteBody": "Ouvrez une session distante pour utiliser le shell.",
      "opening": "Ouverture d'un shell sur l'hôte distant…",
      "openFailed": "Impossible d'ouvrir un shell sur cet hôte.",
      "exited": "Le shell s'est terminé.",
      "retry": "Réessayer",
    },},
    "project": {
        ...
        "createSourceRemote": "Hôte distant",
        "openSourceMenu": "Ajouter une source de projet",
    ...
    "plugins": {
        ...
        "permissionHelp": {
            ...
            "usage.read": "Liste les données d'utilisation des tours terminés (compteurs de tokens par tour, paginés). Aucun contenu de message n'est inclus.",
        }
    },
    "extensions": {
        "scope": {
    ...
    "status": {
        ...
        "unsupportedGlibc": "Cette version Linux nécessite glibc 2.35 ou plus récent (Ubuntu 22.04, Debian 12, Fedora 36+).",
        "dbSchemaTooNew": "Cette version de PI-Desktop est plus ancienne que vos données locales (schéma de données {{found}}, cette version prend en charge {{supported}}). Installez la version plus récente de PI-Desktop qui a ouvert ces données en dernier, ou une version ultérieure.",
        "archMismatch": "Ceci est la version {{buildArch}} exécutée sur une machine {{machineArch}} ; elle tourne par traduction et est plus lente. Installez plutôt la version {{machineArch}}.",
