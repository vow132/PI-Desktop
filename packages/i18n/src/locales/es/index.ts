...
export const es = {
    ...
    "pluginDesktopConsent": {
        ...
        "detail": "Esta es una operación de escritorio peligrosa. El plugin reconoció el riesgo; que se ejecute depende de ti. Deniégala si no la esperabas.",
    ...
    "chat": {
        ...
        "enhancementTimeout": "La reescritura tardó demasiado. Vuelve a intentarlo o elige un modelo más rápido en Ajustes.",
    ...
    "settings": {
        ...
        sklm: {
            ...
            subtitle: "Previsualiza el documento completo antes de guardar.",
            ...
            remoteErrorUnresolved: "El resolutor local no pudo resolver las fuentes del catálogo: se muestran las selecciones integradas",
            previewResolveError: "La comprobación de direcciones de la aplicación no pudo resolver este host: no se instaló nada.",
            dnsHint: "Esa comprobación resuelve el host localmente, mientras que la descarga usaría tu proxy. Si usas un proxy, una VPN o una configuración de DNS propia, revisa Ajustes → General → Red.",
            failureSourceHost: "{{name}} ({{host}})",
            remoteErrorFakeIp: "Tu proxy respondió con direcciones fake-IP para las fuentes del catálogo: se muestran las selecciones integradas",
            previewFakeIpError: "Tu proxy resolvió este host a una dirección fake-IP, así que la comprobación de direcciones de la aplicación lo rechazó: no se instaló nada.",
            fakeIpHint: "Tu proxy respondió {{host}} con {{address}}, un rango de referencia reservado que los proxys usan como marcador fake-IP, no la dirección real de la fuente. Cambia el proxy al modo de proxy del sistema o revisa Ajustes → General → Red.",
            fakeIpHintPlain: "Un proxy local resolvió este host a un marcador fake-IP en un rango reservado, no a la dirección real de la fuente. Cambia el proxy al modo de proxy del sistema o revisa Ajustes → General → Red.",
        ...
        "pluginProviderManaged": "Este proveedor proviene del complemento «{{plugin}}», que proporciona su punto final y sus modelos. Actívelo o desactívelo en la página «Extensiones».",
        "pluginProviderKey": "Clave API",
        "pluginProviderKeyHint": "Se guarda en PI-Desktop y lo usa el entorno de ejecución. El complemento nunca lo recibe.",
        ...
        "mcpMarket": {
            ...
            back: "Mis servidores",
            title: "Mercado MCP",
            subtitle: "El comando exacto se muestra antes de guardar.",
        ...
        "promptEnhancementDesc": "Se aplica a la acción «Mejorar prompt» del compositor. El prompt del sistema es integrado; la plantilla y el modelo se pueden personalizar.",
        "promptEnhancementCustomTemplate": "Usar una plantilla propia",
        "promptEnhancementCustomTemplateDesc": "Reemplaza la plantilla de usuario integrada por la suya. El prompt del sistema sigue integrado.",
        "promptEnhancementCustomTemplateNeedsTemplate": "Guarde primero una plantilla propia; el interruptor elegirá entonces entre ella y la plantilla integrada.",
        ...
        "promptEnhancementThinkingDesc": "Esfuerzo de razonamiento para la reescritura. Desactivado es el valor predeterminado y el más rápido.",
        "promptEnhancementThinkingOff": "Desactivado",
        "promptEnhancementModelFollow": "Seguir el modelo actual",
        "promptEnhancementModelUnavailable": "No disponible: la mejora usará el modelo actual",
        "promptEnhancementUserTemplate": "Plantilla de usuario",
        "promptEnhancementUserTemplateDesc": "Envuelve el borrador. Debe incluir la variable del borrador; use el botón de inserción.",
        "promptEnhancementInsertDraft": "Insertar variable del borrador",
        "promptEnhancementRestore": "Restaurar predeterminado",
        "promptEnhancementMissingDraftVariable": "La plantilla de usuario debe contener la variable del borrador; de lo contrario el borrador no puede enviarse.",
    ...
    "remote": {
        ...
        stepHint: {
            "method": "Elige cómo entrar en este espacio de trabajo y completa la configuración.",
            "config": "Introduce los datos SSH; prepararemos la sesión remota con ellos.",
            "connecting": "Preparando pi-host en la máquina remota. No cierres la ventana.",
            "folder": "Explora los directorios del host y elige la carpeta del proyecto.",
        },
        "methodTitle": "Elegir tipo de conexión",
        "methodSsh": "Host SSH",
        "methodSshDesc": "Host remoto",
        "methodWslDesc": "Subsistema Windows Linux",
        "methodDockerDesc": "Contenedor local",
        "methodUnavailable": "Todavía no disponible",
        "pairedHosts": "Hosts emparejados",
        "configTitle": "Configurar la conexión",
        "configNote": "Introduce los datos SSH; prepararemos la sesión remota con ellos.",
        "hostLabel": "Host",
        "hostPlaceholder": "Dirección o IP, por ejemplo 192.168.1.100",
        "portLabel": "Puerto",
        "userLabel": "Usuario",
        "userPlaceholder": "Usuario, por ejemplo root",
        "labelLabel": "Alias SSH (opcional)",
        "labelPlaceholder": "No usar alias",
        "authLabel": "Autenticación",
        "authPassword": "Contraseña",
        "authKey": "Clave privada",
        "passwordLabel": "Contraseña",
        "passwordPlaceholder": "Contraseña SSH",
        "passwordHint": "La contraseña se guarda en el llavero del sistema para reconectar tras un reinicio.",
        "identityLabel": "Ruta de la clave privada",
        "identityPlaceholder": "Vacío usa ~/.ssh/config y el agente",
        "identityHint": "Vacío: el cliente ssh elige la clave.",
        "connectingTitle": "Conectando",
        "connecting": "Conectando con el host remoto…",
        "connectNote": "La primera conexión descarga y verifica pi-host en la máquina remota.",
        "connect": "Conectar",
        "next": "Siguiente",
        "back": "Atrás",
        stage: {
            "probe": "Comprobar SSH",
            "resolve-release": "Resolver la versión",
            "download-checksum": "Descargar la suma",
            "install": "Instalar pi-host",
            "forward": "Abrir el reenvío",
            "pair": "Emparejar y conectar",
        },
        "wizardTitle": "Conectar con un host remoto",
        "hostStep": "Host remoto",
        "folderStep": "Elegir carpeta",
        "nameStep": "Nombre del proyecto",
        "submit": "Conectar",
        "submitting": "Conectando…",
        "loading": "Cargando…",
        "noFolders": "No hay carpetas aquí",
        "browseRoot": "Inicio",
        "parent": "Subir una carpeta",
        "online": "En línea",
        "offline": "Sin conexión",
        "browseFailed": "Esta carpeta no se puede listar en el host.",
        "cancel": "Cancelar",
        "noHosts": "Todavía no hay ningún host remoto emparejado. Añade uno en Ajustes → Hosts remotos y vuelve aquí para conectar.",

    terminal: {
      "notRemoteTitle": "Terminal",
      "notRemoteBody": "Abra una sesión remota para usar el shell.",
      "opening": "Abriendo un shell en el host remoto…",
      "openFailed": "No se pudo abrir un shell en este host.",
      "exited": "El shell terminó.",
      "retry": "Reintentar",
    },},
    "project": {
        "open": "Abrir proyecto",
        ...
        "createSourceRemote": "Host remoto",
        "openSourceMenu": "Agregar origen del proyecto",
    ...
    "plugins": {
        ...
        "permissionHelp": {
            ...
            "usage.read": "Enumera los datos de uso de los turnos completados (contadores de tokens por turno, paginados). No incluye el contenido de los mensajes.",
        }
    },
    "extensions": {
        "scope": {
    ...
    "status": {
        ...
        "unsupportedGlibc": "Esta versión para Linux requiere glibc 2.35 o posterior (Ubuntu 22.04, Debian 12, Fedora 36+).",
        "dbSchemaTooNew": "Esta versión de PI-Desktop es más antigua que tus datos locales (esquema de datos {{found}}, esta versión admite {{supported}}). Instala la versión más reciente de PI-Desktop que abrió estos datos por última vez, o una posterior.",
        "archMismatch": "Esta es la versión {{buildArch}} ejecutándose en una máquina {{machineArch}}, por lo que corre mediante traducción y es más lenta. Instala la versión {{machineArch}}.",
