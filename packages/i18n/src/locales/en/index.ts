export const en = {
    ...
    tray: {
        ...
        askBody: "When you close the window, PI-Desktop can keep running in the system tray so nothing is lost. You can change this any time in Settings.",
        closeToTray: "Close to tray",
        confirmQuitTitle: "Quit PI-Desktop?",
        confirmQuitBody: "Are you sure you want to quit? All running sessions will be stopped and unsaved changes may be lost.",
        confirmQuit: "Quit",
    },
    /**
    ...
    pluginDesktopConsent: {
        ...
        detail: "This is a dangerous desktop operation. The plugin acknowledged the risk; whether it runs is up to you. Deny if you did not expect it.",
    ...
    pluginFsConsent: {
        ...
        rateDetail: "It has passed {limit} deletions in a minute. This is what a runaway loop looks like; the next one is {path}.",
    ...
    chat: {
        ...
        enhancementTimeout: "The rewrite took too long. Try again, or pick a faster enhancement model in Settings.",
    ...
    settings: {
        ...
        sklm: {
            ...
            back: "My skills",
            title: "Skill Market",
            subtitle: "Preview the full document before saving.",
            ...
            remoteErrorUnresolved: "The local resolver could not answer for the catalog sources — showing built-in picks",
            previewResolveError: "The app's address check could not resolve this host — nothing was installed.",
            dnsHint: "That check resolves the host locally, while the download itself would use your proxy. If you use a proxy, a VPN, or a custom DNS setup, check Settings → General → Network.",
            failureSourceHost: "{{name}} ({{host}})",
            remoteErrorFakeIp: "Your proxy answered the catalog sources with fake-IP addresses — showing built-in picks",
            previewFakeIpError: "Your proxy resolved this host to a fake-IP address, so the app's address check refused it — nothing was installed.",
            fakeIpHint: "Your proxy answered {{host}} with {{address}} — a reserved benchmark range that proxies use as a fake-IP placeholder, not the source's real address. Switch the proxy to system-proxy mode, or check Settings → General → Network.",
            fakeIpHintPlain: "A local proxy resolved this host to a fake-IP placeholder in a reserved range, not to the source's real address. Switch the proxy to system-proxy mode, or check Settings → General → Network.",
        ...
        pluginProviderManaged: "This provider comes from the plugin \"{{plugin}}\", which supplies its endpoint and models. Enable or disable it on the Plugins page.",
        pluginProviderKey: "API key",
        pluginProviderKeyHint: "Stored in PI-Desktop and used by the runtime. The plugin never receives it.",
        ...
        importAgentSkillsDesc: "Find skill folders that Claude, Codex and other agents keep on this machine, then import the ones you want into the selected level.",
        importAgentMcpTitle: "Scan MCP servers from other tools",
        importAgentMcpDesc: "Find MCP configuration from Claude Desktop, Cursor, Codex, Claude Code and opencode on this machine, then add the ones you want to this MCP list.",
        ...
        importAgentScanModeHint: "Copy places a private replica; symlink follows external edits on the next scan but breaks if the source is renamed or removed. Skills only.",
        importAgentScanResult: "Import done: {{imported}} imported, {{skipped}} skipped, {{failed}} failed",
        ...
        mcpMarket: {
            ...
            back: "My servers",
            title: "MCP Market",
            subtitle: "The exact command is shown before anything is saved.",
        ...
        configSync: {
            ...
            connectionDescription: "Synchronize portable configuration through an encrypted WebDAV vault. Conversation history, source files, and runtime state are never included.",
            endpoint: "WebDAV URL",
            endpointPlaceholder: "https://dav.example.com/",
            allowInsecureHttp: "Allow HTTP for a trusted LAN address",
            allowInsecureHttpWarning: "HTTP does not encrypt WebDAV credentials. Enable only for a trusted LAN address; public HTTP endpoints are rejected.",
            remoteMode: "Server compatibility",
            remoteModeHint: "Strict mode requires reliable conditional writes. Use compatibility mode only for a server that ignores If-Match/If-None-Match.",
            remoteModeStrict: "Strict CAS (recommended)",
            remoteModeAppendOnly: "Compatibility mode (append-only)",
            appendOnlyWarning: "This mode is for WebDAV servers that ignore conditional writes. Initialize the vault on one device before joining from others. It uses per-device append-only heads and retains remote history; every device sharing this vault must use compatibility mode. Concurrent changes may still require review.",
            appendOnlyConfirm: "This server mode cannot enforce conditional writes. Compatibility mode retains history but cannot provide atomic compare-and-swap. Continue?",
            username: "Username",
            ...
            backupPasswordHint: "This password encrypts the vault. It never leaves this device.",
            ...
            changePasswordDescription: "Rewrap the vault key without re-encrypting or exposing configuration data.",
            ...
            testUnsupported: "The server did not prove reliable conditional writes; sync is not enabled.",
            testAppendOnlySuccess: "The server supports directory listing for append-only compatibility mode.",
            testAppendOnlyUnsupported: "The server did not prove directory listing for compatibility mode; sync is not enabled.",
            enable: "Enable sync",
            save: "Save and sync",
            ...
            categoriesDescription: "All supported configuration is selected by default. Credentials and memory require an explicit opt-in.",
            ...
            credentialsWarning: "Secrets are encrypted in the vault, but a new device still requires local approval and secure storage.",
            approvalsTitle: "Awaiting local activation",
            approvalsDescription: "Imported executable or security-sensitive configuration is staged until you approve it on this device.",
            approve: "Approve",
            reject: "Reject",
            ...
            historyDescription: "Restore creates a new revision and propagates the selected configuration to subscribed devices.",
            ...
            restore: "Restore",
            restoreConfirm: "Restore this revision? The restored configuration will be published to other subscribed devices after local approvals.",
            restoreStarted: "Restore staged. Review any pending local approvals.",
            disconnectTitle: "Disconnect",
            disconnectDescription: "Preserve local data and leave the remote vault untouched.",
            disconnectConfirm: "Disconnect this device? Local data stays here and remote data will not be deleted.",
        ...
        importModelsScanDesc: "Find local provider and model settings. Stored API keys are copied; subscription logins are not.",
        ...
        marketCustomUrlDesc: "Full URL of a catalog.json. Package paths inside it resolve against this address.",
        ...
        largePasteThresholdDesc: "Text-only pastes longer than this many characters become a temporary session file.",
        ...
        closeBehaviorDesc: "What happens when you close the main window. macOS always keeps the app in the Dock.",
        ...
        vendorPickDesc: "Choose a vendor to sign in with. You can add another account from the same vendor at any time.",
        vendorSignInTo: "Sign in to {{vendor}}",
        vendorConnected: "Connected",
        vendorDisconnected: "Needs sign-in",
        vendorDisconnectedDesc: "This account has no usable credential left. Remove it and add the account again.",
        ...
        vendorBrowserOpened: "Finish signing in in your browser, then come back to this window.",
        vendorBrowserFailed: "Your browser didn't open — copy the link and open it yourself.",
        ...
        promptEnhancementDesc: "Applies to the Composer's Enhance prompt action. The system prompt is built in; the user template and the enhancement model can be customized.",
        promptEnhancementCustomTemplate: "Use a custom template",
        promptEnhancementCustomTemplateDesc: "Replaces the built-in user template with your own. The system prompt stays built in.",
        promptEnhancementCustomTemplateNeedsTemplate: "Save a custom template first; the switch then chooses between it and the built-in template.",
        ...
        promptEnhancementThinkingDesc: "Reasoning effort for the rewrite. Off is the default and the fastest.",
        promptEnhancementThinkingOff: "Off (no reasoning)",
        promptEnhancementModelFollow: "Follow the current model",
        promptEnhancementModelUnavailable: "Unavailable — enhance will fall back to the current model",
        promptEnhancementUserTemplate: "User template",
        promptEnhancementUserTemplateDesc: "Wraps the draft. It must include the draft variable; use the insert button to place it.",
        promptEnhancementInsertDraft: "Insert draft variable",
        promptEnhancementRestore: "Restore default",
        promptEnhancementMissingDraftVariable: "The user template must contain the draft variable, or the draft cannot be sent.",
    ...
    remote: {
        ...
        stepHint: {
            method: "选择进入当前工作区的连接方式，然后继续填写对应的连接配置。",
            config: "填写建立 SSH 连接所需的信息，我们会据此准备远程会话。",
            connecting: "正在远程机器上准备 pi-host，请不要关闭窗口。",
            folder: "浏览远程主机的目录，选择要作为项目根目录的文件夹。",
        },
        methodTitle: "连接方式",
        methodSsh: "SSH 主机",
        methodSshDesc: "远程主机",
        methodWslDesc: "Windows Linux 子系统",
        methodDockerDesc: "本地容器",
        methodUnavailable: "暂不支持",
        pairedHosts: "已配对的主机",
        configTitle: "填写连接配置",
        configNote: "填写建立 SSH 连接所需的信息，我们会据此准备远程会话。",
        hostLabel: "主机",
        hostPlaceholder: "输入主机地址或 IP，例如 192.168.1.100",
        portLabel: "端口",
        userLabel: "用户名",
        userPlaceholder: "输入用户名，例如 root",
        labelLabel: "SSH 配置别名（可选）",
        labelPlaceholder: "不使用别名",
        authLabel: "认证方式",
        authPassword: "密码",
        authKey: "私钥",
        passwordLabel: "密码",
        passwordPlaceholder: "输入 SSH 密码",
        passwordHint: "密码保存在系统钥匙串中，下次启动可直接重连。",
        identityLabel: "私钥路径",
        identityPlaceholder: "留空则使用 ~/.ssh/config 与系统代理",
        identityHint: "留空由 ssh 客户端自行选择密钥。",
        connectingTitle: "连接中",
        "connecting": "正在连接远程主机…",
        connectNote: "首次连接需要在远程机器上下载并校验 pi-host。",
        connect: "开始连接",
        next: "下一步",
        back: "上一步",
        stage: {
            probe: "检查 SSH 连通性",
            "resolve-release": "解析发布版本",
            "download-checksum": "下载校验和",
            install: "安装 pi-host",
            forward: "建立端口转发",
            pair: "配对并连接",
        },
        wizardTitle: "Connect to a remote host",
        hostStep: "Remote host",
        folderStep: "Choose a folder",
        nameStep: "Project name",
        submit: "Connect",
        submitting: "Connecting…",
        loading: "Loading…",
        noFolders: "No folders here",
        browseRoot: "Home",
        parent: "Up one folder",
        online: "Online",
        offline: "Offline",
        browseFailed: "This folder cannot be listed on the host.",
        "cancel": "Cancel",
        noHosts: "No remote host is paired yet. Add one in Settings → Remote Hosts, then connect here.",

    terminal: {
      notRemoteTitle: "Terminal",
      notRemoteBody: "Open a remote session to use the shell.",
      opening: "Opening a shell on the remote host…",
      openFailed: "Could not open a shell on this host.",
    ...
    project: {
        ...
        createSourceRemote: "Remote host",
        openSourceMenu: "Add a project source",
    ...
    plugins: {
        ...
        packagePendingHint: "The publisher listed v{{version}} but has not uploaded its package, so it cannot be installed yet.",
        withdrawn: "Withdrawn",
        ...
        legacyFsDowngraded: "This plugin declares file permissions from before scopes existed, so its reach has been reduced. Update it to restore full function.",
        permissions: {
        ...
        permissionHelp: {
            ...
            "ui.microphone": "Lets the isolated panel request microphone audio. It does not grant camera access.",
            "clipboard.read": "May read whatever is currently on your clipboard and retained clipboard history.",
            ...
            "fs.read": "Read-only access, limited to the paths the plugin declares. Credentials and repository internals are never included.",
            "fs.write": "Can create or change files, limited to the paths the plugin declares. Anything else asks you first.",
            "fs.delete": "Can delete files it declares or wrote itself. Deletions go to the trash, and anything else asks you first.",
            "fs.read.workspace": "Read-only access inside the current project.",
            "fs.write.workspace": "Declared before file scopes existed, so it can no longer write anywhere until the plugin is updated.",
            "fs.delete.workspace": "Declared before file scopes existed, so it can now only delete files it wrote itself.",
            ...
            "agent.complete": "Can spend your model quota on a one-shot completion. The plugin never receives your API keys.",
            ...
            "provider.register": "Adds the providers this plugin defines to Settings' provider list. The plugin supplies the endpoint and models; your API key stays in PI-Desktop.",
            "desktop.control": "Lets the plugin invoke the reviewed PI-Desktop control catalog. Destructive operations still require confirm=true; the MCP bearer token is never exposed.",
            "models.list": "Can see which models you have signed in for. It does not receive keys.",
            "session.read": "Can read the conversation the current tool call is operating on, including tool results.",
            ...
            "mcp.server.remote": "Sends tool calls to a remote MCP endpoint the plugin declared. The endpoint may use unencrypted HTTP.",
            ...
            "browser.cdp": "Can navigate the work-panel browser, read the page, run JavaScript, and send allowlisted Chrome DevTools commands. Cookie and storage methods are blocked.",
            "usage.read": "Lists completed-turn usage facts (paginated token counters and session titles). No message content is included.",
        },
    },
    /**
    ...
    extensions: {
        ...
        mcp: {
            ...
            insecureHttpWarning: "This HTTP connection is not encrypted. Credentials and tool calls may be intercepted.",
            headers: "Headers",
        ...
        subagents: {
            ...
            toolsInheritHint: "Adds Skill, MCP, and plugin tools the parent can call. Task, mode switches, Ask, ToolSearch, and new_context stay with the parent.",
    ...
    status: {
        ...
        unsupportedGlibc: "This Linux build needs glibc 2.35 or newer (Ubuntu 22.04, Debian 12, Fedora 36+).",
        dbSchemaTooNew: "This PI-Desktop is older than your local data (data schema {{found}}, this build supports {{supported}}). Install the newer PI-Desktop that last opened this data, or a later version.",
        archMismatch: "This is the {{buildArch}} build running on a {{machineArch}} machine, so it runs through translation and is slower. Install the {{machineArch}} build instead.",
    ...
    contextCompaction: {
        ...
        recovered: "Context summary failed; recent context was retained and the task is continuing",
        failed: "Context compaction failed",
        longThreadWarning: "Context compacted. Long threads lose earlier detail with each compaction — start a new session for unrelated work.",
    },
    notifications: {
        title: "Notifications",
    ...
    errors: {
        ...
        EMPTY_MODEL_RESPONSE: "The model finished its turn without saying anything, twice in a row. Try again, or rephrase your request.",
        MUTATION_RETRY_BUDGET_EXHAUSTED: "The same edit failed three times, so this turn stopped instead of retrying blind. Ask again to continue.",
        ...
        SUBAGENT_CONTEXT_OVERFLOW: "A subagent's task grew past its model's context limit. Narrow the task, give the subagent a model with a larger context window, or have it read less at once.",
